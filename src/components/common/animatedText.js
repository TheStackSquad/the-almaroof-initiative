...
//     <div
//       ref={ref}
//       className="flex flex-col md:flex-row items-center justify-between p-4 md:p-4 bg-white
//       dark:bg-gray-900 rounded-3xl shadow-xl border border-gray-200
//       dark:border-gray-700 w-full max-w-4xl mx-auto"
//     >
//       {/* Text container with optimized layout */}
//       <div className="relative flex-1 w-full h-12 md:h-16 overflow-hidden mb-4 md:mb-0 md:mr-8 flex items-center justify-center">
//         {canAnimate ? (
...
//         <button className="w-full md:w-auto px-4 py-2 md:px-6 md:py-3 text-sm md:text-base bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
//           Get Started
//         </button>
//       </Link>
//     </div>
