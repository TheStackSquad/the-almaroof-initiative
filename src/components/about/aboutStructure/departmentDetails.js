      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {currentDept.departments.map((subDept, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-6 hover:from-emerald-50 hover:to-teal-50 transition-all duration-300 transform hover:-translate-y-1 shadow-md hover:shadow-lg"
            >
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3">
                ...
                <span className="px-2 py-1 bg-emerald-100 text-emerald-800 text-xs font-bold rounded-full mt-2 sm:mt-0 sm:ml-2">
                  {subDept.staff} Staff
                </span>
              </div>
              <p
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {currentDept.responsibilities.map((responsibility, index) => (
            <div
              key={index}
              className="flex items-start space-x-3 p-4 rounded-lg bg-gray-50 hover:bg-emerald-50 transition-colors duration-300"
            >
