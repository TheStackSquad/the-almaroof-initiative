...
export const contactData = {
  executive: {
    ...
    description:
      "Leadership and administrative officials of Oshodi-Isolo Local Government",
    contacts: [
      {
        id: 1,
        name: "Otunba Kehinde Oloyede Almaroof",
        position: "Executive Chairman",
        department: "Office of the Chairman",
        phone: "+234 812 542 3212", // Mock phone number
      ...
      },
      {
        ...
        phone: "+234 803 456 7890", // Mock phone number
        email: "vicechairman@oshodi-isolo-lg.gov.ng", // Mock email
        address:
          "Oshodi-Isolo Local Government Secretariat, 72 Oyetayo Street, Oshodi, Lagos.",
        image: "/img/vice-chair.webp",
        bio: "Deputy to the Executive Chairman, actively involved in community development and women affairs initiatives.",
      },
      {
        id: 3,
      ...
      {
        id: 5,
        name: "Mr. Segun Adeyemi", // Placeholder name
        position: "Head of Administration",
        department: "Human Resources",
        phone: "+234 806 789 0123", // Mock phone number
  ...
  legislative: {
    ...
    description:
      "Elected councilors representing the various wards of Oshodi-Isolo Local Government",
    contacts: [
      {
        id: 6,
        name: "Hon. Adekunle Balogun", // Placeholder name
        position: "Leader of the House",
        department: "Legislative Assembly",
        ward: "Oshodi/Bolade Ward",
      ...
      {
        id: 7,
        name: "Hon. (Mrs.) Kemi Olatunji", // Placeholder name
        position: "Deputy Leader",
        department: "Legislative Assembly",
        ward: "Orile Oshodi Ward",
      ...
      {
        id: 8,
        name: "Hon. Femi Alade", // Placeholder name
        position: "Councilor",
        department: "Legislative Assembly",
        ward: "Mafoluku Ward",
      ...
      {
        id: 9,
        name: "Hon. Sola Adebiyi", // Placeholder name
        position: "Councilor",
        department: "Legislative Assembly",
        ward: "Shogunle Ward",
      ...
      {
        id: 10,
        name: "Hon. Blessing Okoro", // Placeholder name
        position: "Councilor",
        department: "Legislative Assembly",
        ward: "Shogunle/Alasia Ward",
      ...
      {
        id: 11,
        name: "Hon. David Emeka", // Placeholder name
        position: "Councilor",
        department: "Legislative Assembly",
        ward: "Isolo Ward",
      ...
      {
        id: 12,
        name: "Hon. Aisha Bello", // Placeholder name
        position: "Councilor",
        department: "Legislative Assembly",
        ward: "Ajao Estate Ward",
      ...
      {
        id: 13,
        name: "Hon. Kunle Obafemi", // Placeholder name
        position: "Councilor",
        department: "Legislative Assembly",
        ward: "Ilasamaja Ward",
      ...
      {
        id: 14,
        name: "Hon. Maryam Abdullahi", // Placeholder name
        position: "Councilor",
        department: "Legislative Assembly",
        ward: "Okota Ward",
      ...
      {
        id: 15,
        name: "Hon. Dele Johnson", // Placeholder name
        position: "Councilor",
        department: "Legislative Assembly",
        ward: "Ishagatedo Ward",
